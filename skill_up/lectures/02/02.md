...
<h1>HTML document. structure</h1>
  ...
  <h3>Validator</h3>
  <div>
    <a href="https://validator.w3.org/#validate_by_input+with_options">Validator</a>

    Валидный код не всегда обязательная, но всегда крайне желательная характеристика. Многие ошибки браузер исправит за вас,
    но не всегда это исправление может оказаться ожидаемым и приемлемым.
  </div>
